 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://service.banque.ws.com/", wsdlLocation = "http://localhost:8080/WSTest/BanqueService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICESERVICE_QNAME = new QName("http://service.banque.ws.com/", "BanqueServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WSTest/BanqueService?wsdl");
    ...
    public BanqueWS getBanqueWSPort() {
        return super.getPort(new QName("http://service.banque.ws.com/", "BanqueWSPort"), BanqueWS.class);
    }
    ...
    public BanqueWS getBanqueWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.banque.ws.com/", "BanqueWSPort"), BanqueWS.class, features);
    }
